...
import (
	...
	"github.com/snowcat471/simple-sns-user-service/ent/predicate"
)
...
// LastLoginedAt applies equality check predicate on the "last_logined_at" field. It's identical to LastLoginedAtEQ.
func LastLoginedAt(v time.Time) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldLastLoginedAt), v))
	})
}
...
// LastLoginedAtEQ applies the EQ predicate on the "last_logined_at" field.
func LastLoginedAtEQ(v time.Time) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldLastLoginedAt), v))
	})
}

// LastLoginedAtNEQ applies the NEQ predicate on the "last_logined_at" field.
func LastLoginedAtNEQ(v time.Time) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.NEQ(s.C(FieldLastLoginedAt), v))
	})
}

// LastLoginedAtIn applies the In predicate on the "last_logined_at" field.
func LastLoginedAtIn(vs ...time.Time) predicate.User {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.In(s.C(FieldLastLoginedAt), v...))
	})
}

// LastLoginedAtNotIn applies the NotIn predicate on the "last_logined_at" field.
func LastLoginedAtNotIn(vs ...time.Time) predicate.User {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.NotIn(s.C(FieldLastLoginedAt), v...))
	})
}

// LastLoginedAtGT applies the GT predicate on the "last_logined_at" field.
func LastLoginedAtGT(v time.Time) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.GT(s.C(FieldLastLoginedAt), v))
	})
}

// LastLoginedAtGTE applies the GTE predicate on the "last_logined_at" field.
func LastLoginedAtGTE(v time.Time) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.GTE(s.C(FieldLastLoginedAt), v))
	})
}

// LastLoginedAtLT applies the LT predicate on the "last_logined_at" field.
func LastLoginedAtLT(v time.Time) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.LT(s.C(FieldLastLoginedAt), v))
	})
}

// LastLoginedAtLTE applies the LTE predicate on the "last_logined_at" field.
func LastLoginedAtLTE(v time.Time) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.LTE(s.C(FieldLastLoginedAt), v))
	})
}
