...
func (uu *UserUpdate) SetLastLoginedAt(t time.Time) *UserUpdate {
	uu.mutation.SetLastLoginedAt(t)
	return uu
}
...
func (uu *UserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := uu.mutation.LastLoginedAt(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeTime,
			Value:  value,
			Column: user.FieldLastLoginedAt,
		})
	}
...
// SetLastLoginedAt sets the "last_logined_at" field.
func (uuo *UserUpdateOne) SetLastLoginedAt(t time.Time) *UserUpdateOne {
	uuo.mutation.SetLastLoginedAt(t)
	return uuo
}
...
func (uuo *UserUpdateOne) sqlSave(ctx context.Context) (_node *User, err error) {
	...
	if value, ok := uuo.mutation.LastLoginedAt(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeTime,
			Value:  value,
			Column: user.FieldLastLoginedAt,
